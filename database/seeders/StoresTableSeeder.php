...
class StoresTableSeeder extends Seeder
{
    ...
    $param = [
        ...
        'image_name' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg',
        'created_at' => now(),
    ...
    $param = [
        ...
        'image_name' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg',
        'created_at' => now(),
    ];DB::table('stores')->insert($param);
    $param = [
        'id' => '3',
        ...
        'image_name' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg',
        'created_at' => now(),
    ];DB::table('stores')->insert($param);
    $param = [
        'id' => '4',
        ...
        'image_name' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg',
        'created_at' => now(),
    ];DB::table('stores')->insert($param);
    $param = [
        'id' => '5',
        ...
        'image_name' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg',
        'created_at' => now(),
    ];DB::table('stores')->insert($param);
    $param = [
        'id' => '6',
